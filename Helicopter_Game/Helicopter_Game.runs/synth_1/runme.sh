...
HD_PWD='C:/Users/tdale19/Desktop/Helicopter_Game/Helicopter_Game.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log heli_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source heli_top.tcl
