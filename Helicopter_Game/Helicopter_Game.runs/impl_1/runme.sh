...
HD_PWD='C:/Users/tdale19/Desktop/Helicopter_Game/Helicopter_Game.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log heli_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source heli_top.tcl -notrace
