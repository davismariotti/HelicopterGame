...
architecture heli_top of heli_top is
    ...
    constant TVU: integer := 8;  -- Terminal velocity up  -- was 15
    constant TVD: integer:= 8;   -- Terminal velocity down -- was 12
    ...
    signal walls: wall_data := (23,46,69,92,115,138,161,184,207,230,200,150,100,60,70,50,40,20,10,10,10,100,10,100,10,100,150,160,100,50,20,0); --numbers for height of walls
